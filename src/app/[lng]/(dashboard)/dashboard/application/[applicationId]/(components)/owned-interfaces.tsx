...
const ownedInterfaces: React.FC<OwnedInterfacesProps> = ({
  interfaces,
  app,
  lng
}) => {
  ...
  const columns: ColumnDef<IInterface>[] = [
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          t={t}
          column={column}
          title={t('application_ownedInterfaces_name')}
        />
      ),
      cell: ({ row }) => (
        <div
          className="cursor-pointer"
          onClick={() => displayExistingInterfaceForm(row.getValue('name'))}
        >
          {row.getValue('name')}
        </div>
      )
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          t={t}
          column={column}
          title={t('application_ownedInterfaces_description')}
        />
      ),
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          t={t}
          column={column}
          title={t('application_ownedInterfaces_direction')}
        />
      ),
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          t={t}
          column={column}
          title={t('application_ownedInterfaces_dataObject')}
        />
      ),
      filterFn: (row, id, value) => {
        return value.includes(row.getValue(id));
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          t={t}
          column={column}
          title={t('application_ownedInterfaces_itComponent')}
        />
      ),
      filterFn: (row, id, value) => {
        return value.includes(row.getValue(id));
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          t={t}
          column={column}
          title={t('application_ownedInterfaces_volumetry')}
        />
      )
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          t={t}
          column={column}
          title={t('application_ownedInterfaces_frequence')}
        />
      )
    },
    {
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem>
                <PlusCircledIcon className="mr-2 h-3 w-3" />
                {t('application_ownedInterfaces_addConsumer')}
              </DropdownMenuItem>
              <DropdownMenuItem>
  ...
  const filterableColumnConfigurations = [
    {
      ...
      values: [
        {
          value: 'incoming',
          label: t('application_ownedInterfaces_incoming'),
          icon: ArrowRightToLine
        },
        {
          value: 'outgoing',
          label: t('application_ownedInterfaces_outgoing'),
          icon: ArrowRightFromLine
        },
        {
          value: 'bi-directional',
          label: t('application_ownedInterfaces_biDirectional'),
          icon: ArrowRightLeft
        }
      ]
          ...
          <Card>
            <CardHeader>
              <div className="flex items-start">
                <CardTitle>
                  <Cable className="inline-block h-4 w-4" />{' '}
                  {t('application_ownedInterfaces_providedInterfaces')}
                </CardTitle>
              </div>
            </CardHeader>
            <CardContent>
              <DataTable
                t={t}
                filterPlaceholder={t(
                  'application_ownedInterfaces_placeholderNameFilter'
                )}
                filteredColumn="name"
                columns={columns}
                data={interfaces}
            ...
            <CardFooter>
              <div className="flex flex-row justify-start md:flex md:flex-grow">
                <Button
                  onClick={() => {
                    setInterfaceNameToUpdate(undefined);
