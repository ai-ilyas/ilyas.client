...
const createApplicationForm: React.FC<IApplication[]> = (apps) => {
  ...
  const onSubmit = async (data: ApplicationFormValues) => {
    ...
    catch(error)
    {
      ...
      toast({
        ...
        description: 'There was a problem during the creation of your Application \'' + data.applicationName + '\'.'
      });
      setLoading(false);
    }
  };
    ...
    <AlertDialog>
      ...
      <Form {...form}>
        <form action={postUrl} method='POST' onSubmit={form.handleSubmit(onSubmit)}>
          <AlertDialogHeader>
            <AlertDialogTitle>Create a new application</AlertDialogTitle>
                <div className="gap-8">
                  <FormField
          ...
          <AlertDialogFooter className='mt-4'>
            ...
            <LoadingButton loading={loading} type="submit" text="Créer">
