...
export const applicationNameDefinition = (t: any, apps: IApplication[]) =>
  z
    .string()
...
export const applicationDescriptionDefinition = (t: any) =>
  z
    .string()
...
export const applicationTechnicalOwnerDefinition = (t: any) =>
  z
    .string()
...
export const applicationBusinessOwnerDefinition = (t: any) =>
  applicationTechnicalOwnerDefinition(t);
export const applicationNumberOfUsersDefinition = (t: any) =>
  applicationTechnicalOwnerDefinition(t);
