...
export const interfaceNameDefinition = (t: any, apps: IInterface[]) => z
    .string()
...
export const interfaceDataObjectDefinition = interfaceItComponentDefinition.optional();

export const interfaceVolumetryDefinition = interfaceItComponentDefinition.optional();

export const interfaceFrequenceDefinition = z.union([
    z.literal("hourly"),
    z.literal("daily"),
    z.literal("weekly"),
    z.literal("monthly"),
